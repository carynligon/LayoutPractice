...
var $h1 = $('<h1>I\'m with Her</h1>');
function addStars() {
  i = 0;
  while (i < 25) {
    var $starDiv = $('<div class="star-div"><i class="fa fa-star" aria-hidden="true"></i></div>');
